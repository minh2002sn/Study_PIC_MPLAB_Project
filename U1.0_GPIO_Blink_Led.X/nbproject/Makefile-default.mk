...
FINAL_IMAGE=${DISTDIR}/U1.0_GPIO_Blink_Led.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/U1.0_GPIO_Blink_Led.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
